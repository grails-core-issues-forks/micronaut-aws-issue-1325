...
public class HomeControllerTest {
    ...
    @Test
    void testHelloWorldIsReturned() throws JsonProcessingException {
        ...
        Message msg = objectMapper.readValue(response.getBody(), Message.class);
        Assertions.assertEquals("Hello World", msg.getMessage());
    }
}
